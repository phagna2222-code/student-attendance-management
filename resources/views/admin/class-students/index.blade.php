...
@section('content')
  <div class="card mb-3">
    <div class="card-header"><h5 class="mb-0">{{ __('admin.class_students') }} — {{ __('admin.create_new') }}</h5></div>
    <div class="card-body">
      <form method="POST" action="{{ route('admin.class-students.store') }}">
        @csrf
        <div class="row">
          @include('admin.partials._select', ['name'=>'class_id','label'=>__('admin.classes'),'options'=>$classes,'labelKey'=>'name','required'=>true,'col'=>4])
          @include('admin.partials._select', ['name'=>'student_id','label'=>__('admin.students'),'options'=>$students,'labelKey'=>'name_en','required'=>true,'col'=>4])
          @include('admin.partials._input', ['name'=>'enrolled_at','label'=>'Enrolled At','type'=>'date','col'=>3])
          @include('admin.partials._select', ['name'=>'status','label'=>__('admin.status'),'options'=>[
  ...
  @include('admin.partials._card_index', [
    ...
    'columns' => [
      ...
      ['data'=>'enrolled_at','title'=>'Enrolled'],
